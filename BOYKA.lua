...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/MahmoudM5/ahmed/master/File_Bot/commands.lua") 
...
os.execute('wget https://raw.githubusercontent.com/MahmoudM5/ahmed/master/BOYKA.lua')
...
if SudoBot(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/MahmoudM5/ahmed/master/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/MahmoudM5/ahmed/master/File_Bot/"..file)
if res == 200 then
